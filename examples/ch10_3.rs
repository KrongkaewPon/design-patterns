...
impl GumballMachine {
    fn new(count: i32, location: String) -> Self {
    ...
    fn get_report(&self) {
        println!("Gumball Machine: {}", self.location);
        println!("Current inventory: {}", self.count);
        // let a = self.state;
...
fn main() {
    let mut gumball_machine = GumballMachine::new(2, "Location A".to_string());
    gumball_machine.insert_quarter();
    // gumball_machine.eject_quarter();
    gumball_machine.turn_crank();
    gumball_machine.get_report();
